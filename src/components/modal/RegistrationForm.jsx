...
const RegistrationForm = (props) => {
  ...
  async function screenshot() {
    ...
    const animalPhoto = new File([animalPhotoBlob], "animalPhoto.jpg", {
      type: "image/jpeg",
    });
  ...
  async function handleRegister() {
    ...
    formData.append(
      "animalType",
      getAnimalTypeByIndex(props.gender, props.resultIndex)
    );
      ...
      <ModalContent>
        ...
        >
          <FormControl labelPosition="top">
            <FormLabel help="다운로드 받을 때 필요한 정보입니다">
              학번
            </FormLabel>
            <TextField
          ...
          <FormControl labelPosition="top">
            ...
            <HStack justify="center" style={{ marginBottom: 10 }}>
              {resultImageUrl && (
                <ImageView url={resultImageUrl} height={400} />
              )}
            </HStack>
          </FormControl>
        </ModalBody>
