import agree from "../privacyPolicy/styles/Agree.module.css";
...
const Agree2 = () => {
  return (
    <div>
      ...
      <p>
        <strong>제 3 조 (약관의 공시 및 효력과 변경)</strong>
        <br />
      ...
      <p>
        ...
        <br />
        ①이용신청자가 회원가입 안내에서 본 약관과 개인정보 수집 및 이용약관에
        동의하고 등록절차(회사의 소정 양식의 가입 신청서 작성)를 거쳐 '확인'
        버튼을 누르면 이용신청을 할 수 있다.
        <br />
        ②이용신청자는 반드시 실명과 실제 정보를 사용해야 하며 1개의 생년월일에
        대하여 1건의 이용신청을 할 수 있다.
        <br />
      ...
      <p>
        <strong>제 12 조 (서비스 이용의 제한)</strong>
        <br />
      ...
      <p>
        <strong>제 15 조 (서비스 이용 책임)</strong>
        <br />
      ...
      <p>
        <strong>제 5 장 기타</strong>
      </p>

      <p>
        <strong>제 16 조 (면책 및 손해배상)</strong>
        <br />
        ①천재지변 또는 이에 준하는 불가항력으로 인하여 서비스를 제공할 수 없는
        경우에는 회사의 서비스 제공 책임이 면제된다.
        <br />
      ...
      <p>
        <strong>제 17 조 (개인신용정보 제공 및 활용에 대한 동의서)</strong>
        <br />
        ...
        이용자의 신용을 판단하기 위한 자료로서 활용하거나 공공기관에서
        정책자료로 활용하는데 동의하는 것으로 간주한다.
      </p>

      <p>
        <strong>제 19 조 (분쟁의 해결)</strong>
        <br />
